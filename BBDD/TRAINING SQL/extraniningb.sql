...
SELECT c.nombre "Cliente Nombre", p.pednum  ,  p.importe , pr.descrip , r.nombre "Nombre Representante" -- Las comillas solo se ponen cuando hay espacios o valores especiales si hay b
FROM pedido p
