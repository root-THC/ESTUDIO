...
SELECT ename 
 ...
 --EL NULL ES IMPORTANTE PORQUE AL DEVOLVER UN NULL QUE ES PRESIDENTE NOS DA UN VALOR FALSO POR ESO NO MOSTRARIA NADA SI NO ESTUVIERA WHERE mgr IS NOT NULL
