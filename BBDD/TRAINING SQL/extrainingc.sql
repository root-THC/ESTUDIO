...
SELECT r.nombre , COALESCE(o.ciudad::TEXT,  'sin oficina'  )  Oficina , p.pednum "Numero Pedido" , p.importe "Importe Pedido" , pr.descrip "Descripción" , c.nombre
FROM repventa r 
LEFT JOIN oficina o
