...
SELECT r.nombre , COALESCE(o.ciudad::TEXT,  'sin oficina'  )  Oficina , p.pednum "Numero Pedido" , p.importe "Importe Pedido" , pr.descrip "Descripción"
FROM repventa r 
LEFT JOIN oficina o
...
JOIN producto pr 
ON pr.fabcod = p.fabcodpr.prodcod = p.prodcod AND pr.fabcod = p.fabcod;
