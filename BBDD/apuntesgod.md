...
- **DEFINICIÓN** = Ordenes para poder poder hechos por operadores **DML** deshacer cambios  como un **ctrl + z**  o volver a check points creados dentro de una transacción
