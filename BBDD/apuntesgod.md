...
```sql
 ...
 ```
 -- LECTURA,AÑADIR,MODIFICAR FILAS al usuario prueba es el `usuario` a una tabla dentro de zoo que tengo una que se llama zoo justo pero es solo a esa tabla
