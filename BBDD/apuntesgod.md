...
SIMPLE: TABLA SIN CAMPOS CALCULADOS

COMPLEJA : CON CAMPOS CALCULADOS O TIENE MAS DE UN TABLA
---
scott=> INSERT INTO emp30 
...
El union es para unir los 2 valores de los 2 campos en una unica tabla 
...
pg_hba.conf dice con que metodo de autenticación radius, trust password etc... voy a acceder al sistema gestor.
