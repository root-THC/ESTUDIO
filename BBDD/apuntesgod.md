...
CREATE TABLE tabla_relacion (
    ...
    CONSTRAINT tabla_relacion_fk_t3 FOREIGN KEY (id_tabla3) REFERENCES tabla_4(id_tabla4),
    CONSTRAINT tabla_relacion_fk_t4 FOREIGN KEY (id_tabla3) REFERENCES tabla_3(id_tabla3)
);
```
