...
- **DEFINICIÓN** = Ordenes para poder poder deshacer cambios o volver a check points creados dentro de una transacción como un **ctrl + z** cuando usamos operadores **DML**
