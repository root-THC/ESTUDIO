...
Cuando se aplica una restricción a una clave aliena en `tabla_c`, los registros dependientes en `A Y B` también se aplica en caso de que sea delete se borran en todas y en caso de update se actualizan en .
