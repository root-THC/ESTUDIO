...
--SELECT repcod FROM pedido WHERE repcod IS NOT NULL;
...
SELECT *, fcontrato + 5000 AS "fechanueba" FROM repventa WHERE fcontrato + 5000 BETWEEN '2003-01-01' AND '2003-12-31';
