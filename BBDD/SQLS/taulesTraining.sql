...
--SELECT pednum,fecha,cliecod,repcod,fabcod,prodcod,cant,importe FROM pedido WHERE cliecod = '2111';
...
--SELECT pednum,fecha,cliecod,repcod,fabcod,prodcod,cant,import FROM pedido WHERE cliecod = '2111' AND repcod=103 AND fabcod='aci';
