...
--)
SELECT empno, ename, sal*12 AS "salari anual" FROM emp ORDER BY 3 AS "salari anual"; -- annsal son una especie de etiqueta sera el nombre del campo que aparezca
