...
--(
-- Mostrar nom del empleat el salari, el salari incrementat 20% , de qui mes cobra a menys los que tengan el mismo salrio ordena por nombre y que no aparezcan 
-- Los que trabajan como salesman
