...
SELECT ename, job, deptno, hiredate FROM emp ORDER BY deptno, ename DESC; --Hay que pones ASC o DESC al lado del campo sino no lo coje en este caso mostrara los  
