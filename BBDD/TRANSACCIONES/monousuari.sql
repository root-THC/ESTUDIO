...
-- vuelve al principio o sea que valor 5 y solo con el insert del principio
...
-- Mostaria 12 la suma de VALOR = 8 CON ID 61 Y VALOR = 4 ID 60 ya que volvemos al esta 
